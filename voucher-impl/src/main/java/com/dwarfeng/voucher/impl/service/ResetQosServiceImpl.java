...
import com.dwarfeng.voucher.stack.handler.ResetHandler;
import com.dwarfeng.voucher.stack.handler.Resetter;
import com.dwarfeng.voucher.stack.handler.ResetterHandler;
...
public class ResetQosServiceImpl implements ResetQosService {
    ...
    @Override
    public void resetCheck() throws ServiceException {
        try {
            resetHandler.resetCheck();
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("重置检查时发生异常", LogLevel.WARN, e, sem);
        }
    }
}
