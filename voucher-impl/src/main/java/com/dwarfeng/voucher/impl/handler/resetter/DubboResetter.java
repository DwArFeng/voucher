...
public class DubboResetter extends AbstractResetter {
    ...
    @Value("${com.dwarfeng.voucher.dubbo.provider.group}")
    ...
    public interface DubboResetService extends Service {
         ...
         */
        boolean resetCheck() throws ServiceException;
    }
    ...
    public class DubboResetServiceImpl implements DubboResetService {
        ...
        @Override
        public boolean resetCheck() throws ServiceException {
            try {
                LOGGER.info("接收到检查功能重置消息, 正在重置检查功能...");
                context.resetCheck();
                return true;
            } catch (Exception e) {
