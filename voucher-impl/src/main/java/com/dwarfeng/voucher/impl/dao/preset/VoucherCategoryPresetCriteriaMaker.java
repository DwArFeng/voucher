...
@Component
public class VoucherCategoryPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case VoucherCategoryMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case VoucherCategoryMaintainService.NAME_LIKE:
