...
public class CheckerSupport implements Entity<StringIdKey> {
    ...
    private static final long serialVersionUID = -6441094031597664941L;
    ...
    public CheckerSupport(StringIdKey key, String label, String description, String exampleParam) {
        this.key = key;
        this.label = label;
