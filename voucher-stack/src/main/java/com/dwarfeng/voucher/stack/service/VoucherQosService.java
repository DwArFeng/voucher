 ...
 * @since beta-1.0.0
 */
public interface VoucherQosService extends Service {
     ...
     * @throws ServiceException 服务异常。
     */
    void invalid(VoucherInvalidInfo invalidInfo) throws ServiceException;
     ...
     * @throws ServiceException 服务异常。
     */
    void remove(VoucherRemoveInfo removeInfo) throws ServiceException;
     ...
     * @throws ServiceException 服务异常。
     */
    CompletableFuture<Void> checkValid() throws ServiceException;
     ...
     * @throws ServiceException 服务异常。
     */
    CompletableFuture<Void> removeInvalid() throws ServiceException;
}
