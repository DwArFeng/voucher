 ...
 * @since 1.1.0
 */
public class AfterVoucherInitializeInfo implements Dto {

    private static final long serialVersionUID = -2459920139590286657L;

    private StringIdKey voucherCategoryKey;
    private LongIdKey voucherKey;

    public AfterVoucherInitializeInfo() {
    }

    public AfterVoucherInitializeInfo(StringIdKey voucherCategoryKey, LongIdKey voucherKey) {
    ...
    public String toString() {
        return "AfterVoucherInitializeInfo{" +
